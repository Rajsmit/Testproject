...
public interface Constants {
    ...
    String cityId = "delhi,in"; //Delhi city by choice
    String currentTempUrl = "http://api.openweathermap.org/data/2.5/weather?q=%s" + "&appid=" + appId +"&units=metric";
    String forcastUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=%s" + "&appid=" + appId +"&units=metric&cnt=5";
